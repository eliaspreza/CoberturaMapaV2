...
df_teach_full <- teach %>%
  ...
  mutate(
    # --- CAMBIO REALIZADO SEGÚN TU SOLICITUD ---
    # Se eliminó la división por 1,000,000. Ahora se usan los valores directos.
...
# --- DATOS PESTAÑA 2: GESTIÓN DIRECTIVA (SIN CAMBIOS) ---
...
df_gdirectiva_full <- gdirectiva %>%
  ...
  mutate(
    # La transformación se mantiene aquí porque es para el segundo mapa
